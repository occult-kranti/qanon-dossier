...
| **`research.html`** | A **timeline-ordered bibliography of peer-reviewed scholarship** (2020–2024) on QAnon, each entry showing venue, year, and verified DOI/links — across computer science, sociology, religious studies, cognitive science, HCI, and computational linguistics. Institutional reports (CSIS, ICCT, ADL, Soufan, GWU) are listed separately as *not* peer-reviewed. |
| **`timeline.html`** | A **sourced event chronology** in six eras — precursors, the first Q drop, platform migrations, key drops, violent incidents, and parallel global events — from Pizzagate (2016) to Q's brief 2022 return. |
...
All three pages share one stylesheet and one script and are cross-linked via the navigation in the left rail.
